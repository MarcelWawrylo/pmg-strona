...
<?php if ($edit !== null): ?>
  <form class="box" method="post" enctype="multipart/form-data">
    ...
    <h3><?= $edit['id'] ? 'Edycja wpisu' : 'Nowy wpis' ?></h3>
    ...
    <p class="hint" id="tresc_h">Akapity oddzielaj pustą linią. Śródtytuł: linia zaczynająca się od <code>## </code>. Bez HTML — znaczniki pokażą się jako zwykły tekst.</p>
    ...
    <div class="row"><button type="submit">Zapisz</button><a class="btn btn--light" href="?m=aktualnosci">Anuluj</a></div>
  </form>
  <?php if ($edit['id']): ?>
    <form method="post">
...
<?php else: ?>
  <div class="row" style="margin: 0 0 18px"><a class="btn" href="?m=aktualnosci&nowy">+ Nowy wpis</a><a class="btn btn--light" href="../aktualnosci.html" target="_blank" rel="noopener">Zobacz stronę</a></div>
  <div class="box tabela">
    <table>
      ...
      <?php foreach (pmg_db()->query('SELECT id, data, tytul, opublikowany FROM pmg_aktualnosci ORDER BY data DESC, id DESC') as $r): ?>
        <tr><td><?= h($r['data']) ?></td><td><a href="?m=aktualnosci&id=<?= (int) $r['id'] ?>"><?= h($r['tytul']) ?></a></td><td><?= $r['opublikowany'] ? 'Opublikowany' : '<span class="draft">Szkic</span>' ?></td></tr>
      <?php endforeach; ?>
      </tbody>
    </table>
  </div>
